...
PUSHED_LOWER = {
    "wom 1": ["Education","Hours Worked Per Week","Sex","Occupation"],
    "wom 2": ["Hours Worked Per Week","Age","Sex"],
    "wom 3": ["Sex"],
    "man 1": ["Hours Worked Per Week", "Age"],
    "man 2": [""],
    "man 3": ["Education", "Age"]
}
...
PUSHED_HIGHER = {
    "wom 1": ["Age"],
    "wom 2": ["Occupation", "Education"],
    "wom 3": ["Education","Hours Worked Per Week","Age","Occupation"],
    "man 1": ["Sex", "Education", "Occupation"],
    "man 2": ["Education","Hours Worked Per Week","Age","Sex","Occupation"],
    "man 3": ["Sex", "Hours Worked Per Week", "Occupation"]
}
...
class Result:
    ...
    def __init__(self, series, pid, vis) -> None:
        ...
        if vis == "lime":
           ...
           row_template["interactive_fair"] = 0
           row_template["initial_visualizations"] = 1
        ...
        if vis == "interactive":
           ...
           row_template["forceshap"] = 0
           row_template["anchors"] = 0
           row_template["interactive"] = 1
           row_template["interactive_lower_bias_percep"] = 0
           row_template["interactive_higher_bias_percep"] = 0
           row_template["interactive_fair"] = 0
           row_template["initial_visualizations"] = 0

        if vis == "interactive_lower_bias_percep":
           row_template["cp"] = 0
           row_template["cp_explicit"] = 0
           row_template["eli5"] = 0
           row_template["lime"] = 0
           ...
           row_template["anchors"] = 0
           row_template["interactive"] = 0
           row_template["interactive_lower_bias_percep"] = 1
           row_template["interactive_higher_bias_percep"] = 0
           row_template["interactive_fair"] = 0
           row_template["initial_visualizations"] = 0

        if vis == "interactive_higher_bias_percep":
           row_template["cp"] = 0
           row_template["cp_explicit"] = 0
           row_template["eli5"] = 0
           row_template["lime"] = 0
           ...
           row_template["interactive"] = 0
           row_template["interactive_lower_bias_percep"] = 0
           row_template["interactive_higher_bias_percep"] = 1
           row_template["interactive_fair"] = 0
           row_template["initial_visualizations"] = 0

        if vis == "cp_explicit":
           row_template["cp"] = 0
           row_template["cp_explicit"] = 1
           row_template["eli5"] = 0
           row_template["lime"] = 0
           row_template["shap"] = 0
           row_template["forceshap"] = 0
    ...
    def long_table_rows(self):
        ...
        if "yes" == self.series["discrimination yn"].strip().lower():
            disc = 1
            bias_perception += 1
        if "no" == self.series["fairness app a"].strip().lower():
